...
public:
    ...
    int minDistance(string word1, string word2)
    {
        ...
        // Now LCS means at max kitne characters equal hai toh it is the longest common subsequence and it is common in both strings so ye part dono hi string m hoga. Means iske alawa jo bhi characters hai vo sab extra hai dono hi strings m toh iske alawa jitne characters hai dono string m unko count karo and then return their total
        int lcs = memoisation(word1, word2, n - 1, m - 1);
        int del1 = n - lcs;
        int del2 = m - lcs;
        return del1 + del2;
    }
