...
public:
    ...
    int minInsertions(string s)
    {
        ...
        // tunne LPS nikal liya agr poori string hi palindrome hoti toh phir LPS mera n length ke equal hi aata but agr poori string ni hai and beech beech m kuch elements bekar hai toh at the end m un characters ke liye same hi insert kardu reverse order m toh sahi hai toh n - lps gives me the total number of insertions that I have to do
        return n - memoisation(text1, text2, n - 1, m - 1);
    }
};
/*
